...
def benchmark(input_path: Path, questions: Path, iterations: int, scales: list[int] | None = None) -> list[dict]:
...
if __name__ == "__main__":
    ...
    rows = benchmark(args.input, args.questions, args.iterations, [int(x) for x in args.scales.split(",")]); args.output.parent.mkdir(parents=True, exist_ok=True)
