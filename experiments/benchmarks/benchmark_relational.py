...
def benchmark(db: sqlite3.Connection, iterations: int) -> list[dict]:
    ...
    for name, (query, params) in QUERIES.items():
        ...
        results.append({"backend": "sqlite", "movie_count": movie_count,
                        "intent": name, "iterations": iterations,
...
def main() -> None:
    ...
    parser.add_argument("--output", type=Path,
                        default=Path("experiments/results/benchmarks/relational_benchmark.csv"))
