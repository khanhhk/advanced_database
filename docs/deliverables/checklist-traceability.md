...
| 4 | Mô hình khái niệm và KG schema | Graph schema trong báo cáo | Đáp ứng phần KG schema thuộc phạm vi đã chọn |
| 5 | Luật và suy luận | `cypher/reasoning.cypher` | Triển khai luật nghiệp vụ bằng Cypher |
...
| 13 | Truy vấn inference-enabled | Báo cáo §4.3; `CO_STARRED_WITH` trong Neo4j | Chỉ đáp ứng derived-edge query bằng Cypher |
...
| 18 | Chất lượng báo cáo, hình, tham khảo | `report_latex/`, hình PDF/draw.io, `ref.bib` | PDF cuối phải được kiểm tra trực quan |
