...
3. **Đây có thật sự là đồ thị tri thức hay chỉ là graph database?** Hệ thống có
   stable identity, provenance, ontology, RDF export, semantic constraints,
   inference và bằng chứng; Neo4j chỉ là một lớp thực thi.
4. **Vì sao không dùng quad/named graph?** ảnh chụp dữ liệu hiện dùng triple với namespace
...
8. **Con số 1,0 của phân giải thực thể có đáng tin?** Đó là silver corpus 100 case.
...
10. **Quy trình xử lý dữ liệu có tái lập không?** Raw cache, SHA-256, manifest, exact versions,
...
16. **Hệ thống xử lý câu hỏi ngoài phạm vi thế nào?** Parser trả ý định
    `unknown`; hệ thống không sinh Cypher tùy ý. Mọi fact/bằng chứng đều do Neo4j
    trả về.
17. **Vì sao gợi ý gọi là explainable?** Mỗi shared feature đóng góp một
...
19. **Tại sao chỉ số hiện thấp hơn sản phẩm đầu ra cũ?** Ảnh chụp dữ liệu/tập ứng viên thay đổi;
...
20. **QA 20/20 có đủ không?** Đủ cho smoke/regression của chín ý định, chưa đủ để
...
22. **Phép đo hiệu năng có chứng minh scalability không?** Chưa. Đã đo bốn ảnh chụp dữ liệu con
...
25. **Đóng góp cá nhân quan trọng nhất?** Một quy trình end-to-end có thể chạy lại,
    kết nối đồ thị thuộc tính và semantic standards, đồng thời mọi answer/derived
