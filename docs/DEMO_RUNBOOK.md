...
- recommendation: P@10 `0,715`, NDCG@10 `0,754` trên 20 case silver;
- entity resolution và co-star reasoning đạt `1,00` trên corpus silver;
...
chỉ ở một snapshot 2.000 phim và không chứng minh scalability hay khẳng định một
database luôn nhanh hơn database còn lại.
...
- Neo4j Browser khó trình chiếu: dùng runbook DBeaver tại
  `docs/DBEAVER_NEO4J_DEMO.md` làm phương án thay thế.
