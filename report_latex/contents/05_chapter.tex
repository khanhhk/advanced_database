...
IDF-weighted graph & \textbf{0,635} & \textbf{0,672} & production Neo4j hiện tại \\ \hline
\end{longtable}
...
\reportfigure{query_latency.pdf}{Độ trễ Neo4j và SQLite theo quy mô induced snapshot}{fig:query-latency}
...
\item Sinh induced snapshot 500/1.000/2.000/4.999; benchmark một warm-up và 100 iterations/query; không chạy workload khác song song.
...
\item Kiểm tra mọi bảng, biểu đồ và số liệu công bố dùng cùng phiên bản artifact.
\end{enumerate}
...
Lần chạy cuối của \texttt{make test} đạt 37/37 test. Bộ test gồm unit test cho cleaning,
