...
tra mọi cạnh suy ra phải có ít nhất một phim chung.
...
entity resolution, intent parsing, CRUD, relational benchmark và evidence summary. Integration test
...
\textbf{RQ3:} Cypher rule tạo co-star có supporting movie và validation kiểm tra mọi cạnh suy ra có tiền đề hợp lệ.
