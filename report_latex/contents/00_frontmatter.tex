...
IMDb, bao gồm thu thập và chuẩn hóa dữ liệu, thiết kế lược đồ Property Graph,
nạp dữ liệu vào Neo4j, truy vấn Cypher và luật suy diễn có bằng chứng.
...
biểu diễn tri thức, đồ thị thuộc tính (Property Graph), cơ chế suy
...
dữ liệu, quy trình xử lý dữ liệu (pipeline), lược đồ Neo4j, import và validation.
\item \textbf{Chương 4 – Truy vấn, xử lý và nghiệp vụ:} trình bày các truy vấn
Cypher, câu hỏi năng lực (competency question), cơ chế bảo đảm an toàn truy vấn và các luật
