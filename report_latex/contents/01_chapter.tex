...
trống được lựa chọn là một workflow đầu cuối và kiểm chứng được: thu thập đa
nguồn, identity/provenance, hai biểu diễn graph, suy diễn có evidence, API/UI,
kiểm thử và artifact thực nghiệm. Điểm khác biệt quan trọng là QA chỉ thực thi
